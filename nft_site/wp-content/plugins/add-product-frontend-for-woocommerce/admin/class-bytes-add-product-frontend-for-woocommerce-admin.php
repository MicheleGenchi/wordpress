...
if(!class_exists('APFFW_Bytes_Add_Product_Frontend_For_Woocommerce_Admin')){
	class APFFW_Bytes_Add_Product_Frontend_For_Woocommerce_Admin {
		...
		public function apffw_custom_menu_page_bytes_add_product_frontend_for_woocommerce(){
			...
			add_submenu_page('bytes-product-frontend-info', 'Information', 'Information', 'manage_options', 'bytes-product-frontend-info');
		...
		public function apffw_frontend_product_display_options(){
	        ...
	        add_settings_section("header_section", "Options", array($this, "apffw_display_header_options_content"), "plugin-options");
	        ...
	        add_settings_field("frontend_product_user_role", "Select User Role", array($this, "apffw_display_user_role_field_bytes_product_frontend_form"), "plugin-options", "header_section");
